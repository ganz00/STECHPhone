...
public class Writter {
    ...
    public Writter(String dir,int nb,String Heure,Erreur er ,Handler h) {
        this.er =er;
        this.handler = h;
        myFile = new File[nb];
        this.dir = dir;
    ...
    public void WriteSettings(String valeurs, String mode, String date, String nu, String operateur,int a,String heure) {
            ...
            this.myFile[a] = new File(Environment.getExternalStorageDirectory() +
                    File.separator + dir + File.separator + nu + "_" + operateur + " " + mode + "_" + date +" "+heure+ ".txt"); //on déclare notre futur fichier
    ...
    public void WriteSettings(String valeurs, String heure ,String date ) {
        ...
        this.myFile[0] = new File(Environment.getExternalStorageDirectory() +
                File.separator + dir + File.separator +"Erreur"+ "_" + date +"_"+heure+ ".txt"); //on déclare notre futur fichier
